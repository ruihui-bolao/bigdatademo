...
public class TDDataServiceImpl implements TDDataService {
    ...
    public static void main(String[] args) {
        ...
        final TDDataService tdDataService = (TDDataServiceImpl) context.getBean("tdDataService");

        final String app_info = tdDataService.getDataInfo("da:a1:19:fd:78:2c", "app_info");
        System.out.println(app_info);

        tdDataService.updateInfo("da:a1:19:fd:78:2c", "app_info", "dchjkchsjkcjk");
    }
}
