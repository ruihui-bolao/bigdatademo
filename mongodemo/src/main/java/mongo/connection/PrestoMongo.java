 ...
 *
 * 通过 presto 连接 mongo（使用presto连接mongo，可以实现使用传统的sql语句进行查询）
 */
...
//        Connection connection = DriverManager.getConnection("jdbc:presto://192.168.1.238:9098/mongodb/data720", "hui", null);
        Connection connection = DriverManager.getConnection("jdbc:presto://192.168.1.115:8888/mongodb/wifimac", "hui", null);
        Statement statement = connection.createStatement();
        // 查询命令（单条查询）
        String query2 = "show tables";
//        String query2 = "select * from currDay2 limit 10";
        // 按时间段查询
